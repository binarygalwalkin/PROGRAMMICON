// Fig. 20.15: PathNavigatorForm.cs
...
using System.Xml.XPath; // for XPathSelectElement
         ...
         object sender, EventArgs e )
      {
         ...
         switch ( locateComboBox.SelectedIndex )
         {
            ...
            case 2: // print all name elements
               PrintElements( document.Descendants( "name" ) );
               break;
            case 3: // print all paragraph elements
               PrintElements(
                  document.XPathSelectElements( "//paragraph" ) );
               break;
